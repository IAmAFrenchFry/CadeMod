package com.cademissner.cademod.screens;
...
public class FirstBlockScreen extends ContainerScreen<FirstBlockContainer> {
	...
	private ResourceLocation GUI = new ResourceLocation(CadeMod.MODID, "textures/gui/firstblock_gui.png");
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		this.font.drawString(this.field_213127_e.getDisplayName().getFormattedText(), 8.0F,
